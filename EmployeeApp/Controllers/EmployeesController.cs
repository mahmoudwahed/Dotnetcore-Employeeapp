...
namespace EmployeeApp.Controllers
{
    ...
    {
        private readonly AdventureWorks2016CTP3Context _context;

        public EmployeesController(AdventureWorks2016CTP3Context context)
        {
            _context = context;    
        }
        ...
        {
            var adventureWorks2016CTP3Context = _context.Employee.Include(e => e.BusinessEntity);
            return View(await adventureWorks2016CTP3Context.ToListAsync());
        }
